<h2><img src="templates/images/gifs/barista_32.gif" alt="noticias" />{#titulo_noticia#}</h2>
...
{listagem->setTable id="tabela1" caption=#titulo_tabela01# indice="ID_NEWS" adm="edit,del" NumPage="8" ClassLinha="class1,class2,class3"}
