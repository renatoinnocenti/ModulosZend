...
InsertVariableCommand.Execute=function() {
        ...
        window.open(FCKConfig.PluginsPath + 'insertvariables/insertVariable.html', 'insertVariable', 'width=500,height=400,scrollbars=no,scrolling=no,location=no,toolbar=no');
        //window.open('http://localhost/guia/index.php?page=traducao', 'insertVariable', 'width=500,height=400,scrollbars=no,scrolling=no,location=no,toolbar=no');
}
...
oInsertVariables.IconPath = FCKConfig.PluginsPath + 'insertvariables/cake.gif'; //specifies the image used in the toolbar
