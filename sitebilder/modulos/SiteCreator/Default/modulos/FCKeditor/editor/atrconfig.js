...
FCKConfig.ToolbarSets["Noticia"] = [
	['Bold','Italic','Underline','StrikeThrough','-','OrderedList','UnorderedList','-','Link','Unlink','-','Cut','Copy','Paste','PasteText']
] ;
FCKConfig.ToolbarSets["EditorSimples"] = [
	...
	['Style','FontFormat','SpecialChar','TextColor','BGColor']
] ;
FCKConfig.ToolbarSets["BasicNoticias"] = [
	['Source','DocProps','FitWindow','NewPage','Preview','-','Templates'],
	['Cut','Copy','Paste','PasteText'],
	['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
	['Save','About','mycombo','serverPreview'],
	'/',
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
	['OrderedList','UnorderedList','-','Outdent','Indent'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	...
	['Image','Flash','Table','Rule'],
	['Style','FontFormat'],
	['SpecialChar','TextColor','BGColor'],
	'/',
	['Teste','Insert_Variables',"Flash"]
] ;
