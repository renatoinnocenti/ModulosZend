...
class Arquivo {
    ...
    ## ie. ./teste/teste                                 ##
    #######################################################
    function SetOrigem($origem,$checagem=false){
    ...
    ####################################################################
    ## Checa se há espaço na HD do servidor                           ##
    ## FreeDisc($por)                                                 ##
    ## $por = porcentagem de espaço livre de segurança                ##
    ####################################################################
    ...
    ## $tipo = Formato da conversão (KB,MB,GB)                        ##
    ####################################################################
    ...
    #######################################################################################
    ## Extrai a extenção de um arquivo e o seu nome                                      ##
    ## ExtFile($filename)                                                                ##
    ## $filename = nome original do arquivo (ex: arquivo.zip)                            ##
    ## Retorna um array contendo 0=> Nome 1=> Extenção                                   ##
    #######################################################################################
    ...
    ## $check = true verifica se é mime valido                      ##
    ## $mime = Se o arquivo ja apresenta um tipo mime à verificar   ##
    ...
    ## $destino = patch onde será criado o thumbnail                  ##
